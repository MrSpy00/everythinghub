    ...
    <section className="relative flex flex-col items-center justify-center px-4 pt-16 pb-20 text-center sm:pt-24 sm:pb-28 lg:pt-32 lg:pb-36">
      ...
      <div className="mb-12 w-full max-w-xl">
        <NeonBorder color="#8b5cf6" rounded={20} glow={60}>
          <div className="relative flex items-center rounded-[18px] bg-[var(--hub-surface)]/95 p-2 shadow-2xl backdrop-blur-2xl">
            ...
            <a
              href="#tools"
              className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-indigo-500/40 bg-indigo-500/20 px-4 py-2 text-xs font-semibold text-white backdrop-blur-xl transition-all hover:scale-105 hover:bg-indigo-500/30 hover:border-indigo-400"
              data-cursor="Keşfet"
            >
      ...
      <div className="mb-16 flex flex-wrap items-center justify-center gap-4">
        <Link
          ...
          className="group flex items-center gap-2.5 rounded-2xl border border-white/20 bg-white/[0.06] px-7 py-3.5 text-sm font-bold text-white backdrop-blur-2xl shadow-2xl shadow-indigo-500/10 transition-all hover:scale-105 hover:bg-white/[0.12] hover:border-indigo-400/80"
          data-cursor="YouTube"
        >
