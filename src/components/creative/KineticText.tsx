...
export function KineticText({ intervalMs = 2800 }: { intervalMs?: number }) {
  ...
  return (
    <div className="relative my-3 sm:my-4 w-full max-w-3xl mx-auto h-12 sm:h-14 md:h-16 flex items-center justify-center select-none overflow-hidden px-2">
      {/* 1. Multi-Layer Ultra-Soft Gaussian Ambient Glow */}
      ...
      <div className="relative z-10 w-full flex items-center justify-center">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="flex items-center justify-center rounded-full border border-white/12 bg-white/[0.05] px-5 sm:px-8 py-2 sm:py-2.5 backdrop-blur-2xl shadow-2xl shadow-black/40 max-w-full"
          >
