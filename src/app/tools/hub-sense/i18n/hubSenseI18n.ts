...
export const hubSenseTranslations: Record<"tr" | "en", HubSenseDictionary> = {
  tr: {
    ...
    disciplines: {
      color: {
        label: "Renk",
        desc: "5 tonu incele, 3 eksenli renk matrisinden yeniden oluştur. CIELAB Delta-E standardı.",
      ...
      sound: {
        label: "Ses",
        desc: "5 frekansı dinle, perdeyi bellekten yeniden sentezle. ERB psikokustik modeli.",
      ...
      time: {
        label: "Zaman",
        desc: "5 süreyi gözlemle, butonu basılı tutarak tam sürede bırak. Weber-Fechner yasası.",
      ...
      shape: {
        label: "Şekil",
        desc: "5 şekli gör, boyut/rotasyon/pozisyonu yeniden kurgula. IoU çakışma puanlama.",
      ...
      sequence: {
        label: "Dizi",
        desc: "Artan harmonik ses-ışık zincirini eksiksiz tekrarla. Dual working memory.",
  ...
  en: {
    ...
    disciplines: {
      color: {
        label: "Color",
        desc: "Memorize 5 tones, reconstruct from 3-axis color matrix. CIELAB Delta-E standard.",
      ...
      sound: {
        label: "Sound",
        desc: "Listen to 5 frequencies, synthesize pitch from memory. ERB psychoacoustic model.",
      ...
      time: {
        label: "Time",
        desc: "Observe 5 durations, press and release at the exact time. Weber-Fechner law.",
      ...
      shape: {
        label: "Shape",
        desc: "Inspect 5 shapes, recreate scale/rotation/position. IoU intersection scoring.",
      ...
      sequence: {
        label: "Sequence",
        desc: "Repeat increasing harmonic audio-visual sequence. Dual working memory.",
